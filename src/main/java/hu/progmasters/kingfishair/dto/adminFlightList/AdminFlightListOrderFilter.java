...
public class AdminFlightListOrderFilter {

    private Long order;

    private String filterFlightNr;
    ...
    public AdminFlightListOrderFilter() {
    }

    public AdminFlightListOrderFilter(Long order, String filterFlightNr, String filterDepAirportName, String filterArrAirportName, Long itemPerPage, Long page) {
        this.order = order;
        this.filterFlightNr = filterFlightNr;
    ...
    public String getFilterFlightNr() {
        return filterFlightNr;
    }

    public void setFilterFlightNr(String filterFlightNr) {
        this.filterFlightNr = filterFlightNr;
    }
